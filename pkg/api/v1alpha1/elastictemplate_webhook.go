...
// +kubebuilder:webhook:path=/mutate-elastic-carrefour-com-v1alpha1-elastictemplate,mutating=true,failurePolicy=fail,groups=elastic.carrefour.com,resources=elastictemplates,verbs=create;update,versions=v1alpha1,name=melastictemplate.kb.io,sideEffects=none,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:verbs=create;update;delete,path=/validate-elastic-carrefour-com-v1alpha1-elastictemplate,mutating=false,failurePolicy=fail,groups=elastic.carrefour.com,resources=elastictemplates,versions=v1alpha1,name=velastictemplate.kb.io,sideEffects=none,admissionReviewVersions=v1beta1
