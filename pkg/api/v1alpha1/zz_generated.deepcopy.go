...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticPipeline) DeepCopyInto(out *ElasticPipeline) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticPipeline.
func (in *ElasticPipeline) DeepCopy() *ElasticPipeline {
	if in == nil {
		return nil
	}
	out := new(ElasticPipeline)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ElasticPipeline) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticPipelineList) DeepCopyInto(out *ElasticPipelineList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ElasticPipeline, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticPipelineList.
func (in *ElasticPipelineList) DeepCopy() *ElasticPipelineList {
	if in == nil {
		return nil
	}
	out := new(ElasticPipelineList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ElasticPipelineList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticPipelineSpec) DeepCopyInto(out *ElasticPipelineSpec) {
	*out = *in
	in.ElasticURI.DeepCopyInto(&out.ElasticURI)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticPipelineSpec.
func (in *ElasticPipelineSpec) DeepCopy() *ElasticPipelineSpec {
	if in == nil {
		return nil
	}
	out := new(ElasticPipelineSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticPipelineStatus) DeepCopyInto(out *ElasticPipelineStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticPipelineStatus.
func (in *ElasticPipelineStatus) DeepCopy() *ElasticPipelineStatus {
	if in == nil {
		return nil
	}
	out := new(ElasticPipelineStatus)
	in.DeepCopyInto(out)
	return out
}
