...
// +kubebuilder:webhook:path=/mutate-elastic-carrefour-com-v1alpha1-elasticindex,mutating=true,failurePolicy=fail,groups=elastic.carrefour.com,resources=elasticindices,verbs=create;update,versions=v1alpha1,name=melasticindex.kb.io,sideEffects=none,admissionReviewVersions=v1
...
// +kubebuilder:webhook:verbs=create;update;delete,path=/validate-elastic-carrefour-com-v1alpha1-elasticindex,mutating=false,failurePolicy=fail,groups=elastic.carrefour.com,resources=elasticindices,versions=v1alpha1,name=velasticindex.kb.io,sideEffects=none,admissionReviewVersions=v1
